...
class AppColors {
  ...
  static const Color primaryLight = Color(0xFF4DAEDF);

  /// Primary 어두운 변형 (active states)
  static const Color primaryDark = Color(0xFF0C75A8);

  /// Primary 매우 연한 배경 (10% opacity)
  static const Color primaryContainer = Color(0x1A1193D4);

  /// Primary 연한 배경 (20% opacity)
  static const Color primaryContainerLight = Color(0x331193D4);
  ...
  /// 시스템 트레이 아이콘 색상
  static const Color trayIcon = Color(0xFF1193D4);
